...
def normalize_bo_config(config: dict) -> dict:
    ...
    cfg["analysis"].setdefault("left_min_voltage_min_v", None)
    cfg["analysis"].setdefault("left_min_voltage_max_v", None)
    cfg["analysis"].setdefault("right_min_voltage_min_v", None)
    cfg["analysis"].setdefault("right_min_voltage_max_v", None)
